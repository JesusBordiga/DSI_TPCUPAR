...
namespace CUPAR.Entidades
{
    internal class Probando
    {
        ...
        public static List<Vino> crearListaVinos()
        {
            ...
            {
                vinos.Add(new Vino(bodega, 2018, $"Vino 20 {bodega.getNombre()}", "Nota del Catador 20", 300, maridajesVino2, varietales1, 700));
                vinos.Add(new Vino(bodega, 2018, $"Vino 20 {bodega.getNombre()}", "Nota del Catador 20", 300, maridajesVino2, varietales1, 700));
                vinos.Add(new Vino(bodega, 2018, $"Vino 20 {bodega.getNombre()}", "Nota del Catador 20", 300, maridajesVino3, varietales2, 700));
                vinos.Add(new Vino(bodega, 2018, $"Vino 20 {bodega.getNombre()}", "Nota del Catador 20", 300, maridajesVino1, varietales3, 700));
