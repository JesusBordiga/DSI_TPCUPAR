...
namespace CUPAR
{
    internal static class Program
    {
        ...
        static void Main()
        {
            ...
            GestorImportarVinoDeBodega gestorImportarVinoDeBodega = new GestorImportarVinoDeBodega(crearListadoDeBodegas(), crearListaVinos());
        ...
        public static List<TipoUva> crearListaTipoVinos()
        {
